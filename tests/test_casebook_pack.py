"""Regression checks for the tidal-mob-push-lens casebook."""
...
from casebook.harness import assert_expected, tidal_mob_push_lens_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(tidal_mob_push_lens_summary(), assert_expected())
